        ...
        <div class="container-fluid">
            <div class="card card-outline card-secondary">
                <div class="card-header">
                    <h2 class="card-title">Data Daftar Tamu</h2>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover text-center" id="" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Nama Lengkap</th>
                        ...
                        <tr>
                            ...
                            <td><?= $row['asal_tamu']; ?></td>
                            <td>
                                <img class="img-fluid rounded" src="daftar-tamu/image/<?= $row['img_dir']; ?>"
                                    alt="Profil" width="50" height="50">
                            </td>
                            <td>
                                <a class="btn btn-info btn-sm ubah" data-toggle="modal"
                                    data-target="#showModal<?= $row["tamu_id"]; ?>"><i class="fas fa-eye"></i>
                                </a>
                            </td>
                        </tr>

                        <!-- Show Modal -->
                        <div class="modal fade" id="showModal<?= $row["tamu_id"]; ?>" tabindex="-1" role="dialog"
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="nama_lengkap"
                                                                ...
                                                                placeholder="Masukkan Nama Lengkap Tamu" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="jenis_kelamin"
                                                                id="jenis_kelamin" value="<?= $row["jenis_kelamin"]; ?>"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="no_tlp"
                                                                id="no_tlp" value="<?= $row["no_tlp"]; ?>"
                                                                placeholder="Masukkan No.Telephone" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="asal_tamu">Asal Tamu</label>
                                                            <input type="text" class="form-control" name="asal_tamu"
                                                                id="asal_tamu" value="<?= $row["asal_tamu"]; ?>"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="pegawai_id"
                                                                id="pegawai_id" value="<?= $pegawai["nama_pegawai"]; ?>"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>
                                                            <input type="text" class="form-control" name="keperluan_id"
                                                                id="keperluan_id"
                                                                value="<?= $keperluan["ket_keperluan"]; ?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <img class="img-fluid border border-dark rounded"
                                                    src="daftar-tamu/image/<?= $row['img_dir']; ?>" alt="Profil">
                                            </div>
                                        </div>
                                    </div>
